    ...
    <div class="row layout-top-spacing">
        <div class="col-lg-12 col-12">
            <div class="card">
                ...
                <form action="{{ isset($note) ? route('admin.note.update', $note->id) : route('admin.note.store') }}"
                            ...
                            <div class="custom-file-container" data-upload-id="myFirstImage">
                                ...
                                <div class="custom-file-container__image-preview">
                                    @if(isset($note) && $note->image)
                                        <img id="currentImage" src="{{ asset('storage/' . $note->image) }}" alt="Current Image" style="max-width: 100px; max-height: 100px;">
                                    @endif
                                </div>
                            </div>
                        </div>
